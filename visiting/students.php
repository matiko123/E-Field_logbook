...
$query1 = "SELECT student.id,student.name,student.contact,student.course,student.year from  student inner join field_selection on field_selection.student=student.id inner join organization on organization.id=field_selection.organization inner join visiting_organization on visiting_organization.organization=field_selection.organization  where visiting_organization.visitor=$id and field_selection.verification=1";
                                        ...
                                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                            <table class="table my-0" id="dataTable">
                                                ...
                                                <?php    $i=1;
                                                        ...
                                                        <td>$course</td>
                                                        <td>$year</td>
                                                        <td><button class='btn btn-outline-success' type='button' onclick='window.location.href=\"logbooks.php?id=$student\"'>View</button></td>
                                                    </tr>
                                                                    ";
                                                                    $i++;
                                                                }         
